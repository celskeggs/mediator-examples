...
func NewObjCheese(realm *types.Realm, params ...types.Value) *types.Datum {
	i := &ObjCheeseImpl{}
	d := realm.NewDatum(i)
	...
	NewObjCheeseData(d, &i.ObjCheeseData, params...)
	return d
}

func (t *ObjCheeseImpl) Type() types.TypePath {
	return "/obj/cheese"
}

func (t *ObjCheeseImpl) Var(src *types.Datum, name string) (types.Value, bool) {
	switch name {
	case "type":
		return types.TypePath("/obj/cheese"), true
	case "parent_type":
...
func (t *ObjCheeseImpl) SetVar(src *types.Datum, name string, value types.Value) types.SetResult {
	switch name {
	case "type":
...
func (t *ObjCheeseImpl) Proc(src *types.Datum, usr *types.Datum, name string, params ...types.Value) (types.Value, bool) {
	switch name {
	case "Bump":
