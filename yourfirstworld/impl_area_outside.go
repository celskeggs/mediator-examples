...
func NewAreaOutside(realm *types.Realm, params ...types.Value) *types.Datum {
	i := &AreaOutsideImpl{}
	d := realm.NewDatum(i)
	...
	NewAreaOutsideData(d, &i.AreaOutsideData, params...)
	return d
}

func (t *AreaOutsideImpl) Type() types.TypePath {
	return "/area/outside"
}

func (t *AreaOutsideImpl) Var(src *types.Datum, name string) (types.Value, bool) {
	switch name {
	case "type":
		return types.TypePath("/area/outside"), true
	case "parent_type":
...
func (t *AreaOutsideImpl) SetVar(src *types.Datum, name string, value types.Value) types.SetResult {
	switch name {
	case "type":
...
func (t *AreaOutsideImpl) Proc(src *types.Datum, usr *types.Datum, name string, params ...types.Value) (types.Value, bool) {
	switch name {
	case "Bump":
...
func (t *AreaOutsideImpl) SuperProc(src *types.Datum, usr *types.Datum, chunk string, name string, params ...types.Value) (types.Value, bool) {
	switch chunk {
...
func (t *AreaOutsideImpl) ProcSettings(name string) (types.ProcSettings, bool) {
	switch name {
	case "Bump":
...
func (t *AreaOutsideImpl) Chunk(ref string) interface{} {
	switch ref {
	case "github.com/celskeggs/mediator-examples/yourfirstworld.AreaOutsideData":
		return &t.AreaOutsideData
