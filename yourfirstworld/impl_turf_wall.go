...
func NewTurfWall(realm *types.Realm, params ...types.Value) *types.Datum {
	i := &TurfWallImpl{}
	d := realm.NewDatum(i)
...
func (t *TurfWallImpl) Type() types.TypePath {
	return "/turf/wall"
}

func (t *TurfWallImpl) Var(src *types.Datum, name string) (types.Value, bool) {
	switch name {
	case "type":
		return types.TypePath("/turf/wall"), true
	case "parent_type":
...
func (t *TurfWallImpl) SetVar(src *types.Datum, name string, value types.Value) types.SetResult {
	switch name {
	case "type":
...
func (t *TurfWallImpl) Proc(src *types.Datum, usr *types.Datum, name string, params ...types.Value) (types.Value, bool) {
	switch name {
	case "Bump":
...
func (t *TurfWallImpl) SuperProc(src *types.Datum, usr *types.Datum, chunk string, name string, params ...types.Value) (types.Value, bool) {
	switch chunk {
